                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            <tr>
                                <?php $i++; ?>
                                <td>{{ $i }}</td>
                                <td>{{ $Infringement_Item->item }}</td>
                                <td class="text-danger">{{ $Infringement_Item->Points_Rebate }}</td>
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#delete{{ $Infringement_Item->id }}"
                                            title="{{ trans('Infringements_Item_trans.delete_Item_Infringement') }}"><i
                                            class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                            <!-- edit_modal_Infringement -->
                            <div class="modal fade" id="edit{{ $Infringement_Item->id }}" tabindex="-1" role="dialog"
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input id="Name" type="text" name="Name"
                                                               class="form-control"
                                                               value="{{ $Infringement_Item->item }}"
                                                               required>
                                                        <input id="id" type="hidden" name="id" class="form-control"
                                                               value="{{ $Infringement_Item->id }}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="Name_en"
                                                        ...
                                                        <input type="number" class="form-control"
                                                               value="{{$Infringement_Item->Points_Rebate}}"
                            ...
                            <div class="modal fade" id="delete{{ $Infringement_Item->id }}" tabindex="-1" role="dialog"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
