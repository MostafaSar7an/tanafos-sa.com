...
@section('css')
    @toastr_css
    @section('title')
        {{ trans('Infringements_Item_trans.title_page') }}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    @section('PageTitle')
        {{ trans('Infringements_Item_trans.List_Infringements') }}
    @stop
    <!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            <tr>
                                <th>#</th>
                                <th>{{ trans('Infringements_Item_trans.Item') }}</th>
                                <th>{{ trans('Infringements_Item_trans.Points_Rebate') }}</th>
                                <th>{{ trans('Infringements_Item_trans.Notes') }}</th>
                                <th>{{ trans('Infringements_Item_trans.Processes') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $i = 0; ?>
{{--                            @foreach ($Infringements as $Infringement)--}}
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#edit"
                                            title="{{ trans('Infringements_Item_trans.Edit') }}"><i class="fa fa-edit"></i></button>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#delete"
                                            title="{{ trans('Infringements_Item_trans.Delete') }}"><i
                                            class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                <form action="{{ route('Infringements.update', 'test') }}" method="post">
                                                    {{ method_field('patch') }}
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col">
                                                        ...
                                                        <div class="col">
                                                            <label for="Name_en"
                                                                   class="mr-sm-2">{{ trans('Infringements_Item_trans.Points_Rebate') }}
                                                                :</label>
                                ...
                                <div class="modal fade" id="delete" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('Infringements.destroy', 'test') }}" method="post">
                                                    {{ method_field('Delete') }}
                                                    @csrf
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- add_form -->
                        <form action="{{ route('Infringements.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col">
