                    ...
                    @endif
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="box">
                                                    <select class="fancyselect" name="fee_id" required>
                                                        <option value="">-- اختار من القائمة --</option>
                                                        <option value="">إثارة الفوضى داخل الفصل</option>
                                                        <option value="">عدم حل الواجب رقم ١٢</option>
                                                    </select>
                                                </div>

                                            </div>
                                            <div class="col">
                                                <label for="Name_en" class="ml-sm-2">نوع المخالفة</label>
                                                <div class="box">
                                                    <select class="fancyselect" name="fee_id" required>
                                                        <option value="">-- اختار من القائمة --</option>
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">تفاصيل المخالفة</label>
                                <input type="text" value="" name="title_en" class="form-control">
                            </div>


                            <div class="form-group col">
                                <label for="inputEmail4">مكان المخالفة</label>
                                <input type="text" value="" name="amount" class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">محرر المخالفة</label>
                                <input type="text" value="" name="title_en" class="form-control">
                            </div>
                            <div>
