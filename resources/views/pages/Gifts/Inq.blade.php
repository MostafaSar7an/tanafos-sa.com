                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            <thead>
                            <tr>
                                <th>رقم المنحةاو المكافأءة</th>
                                <th>اسم الطالب</th>
                                <th>البند</th>
                                <th>نوع المنحةاو المكافأءة</th>
                                <th>عدد النقاط</th>
                                <th>تفاصيل المنحةاو المكافأءة</th>
                                <th>مكان المنحةاو المكافأءة</th>
                                <th>محرر المنحةاو المكافأءة</th>
                                <th>تاريخ الأصدار</th>
                                <th>العمليات</th>
                            </tr>
                            </thead>
...
{{--                            @foreach ($Infringement_Items as $Infringement_Item)--}}
                            <tr>
                                ...
                                <td>إثارة الفوضى داخل الفصل</td>
                                <td>سلوك</td>
                                <td class="text-success">12-</td>
                                <td class="">تفاصيل...</td>
                                <td class="">الفصل</td>
                                <td class="text-success">مسؤول النظام</td>
                                <td class="text-success">2024-1-1</td>
                                <td>
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#edit"
                                            title="تعديل المخالفة"><i class="fa fa-edit"></i></button>
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#delete"
                                            title="اسقاط المخالفة"><i
